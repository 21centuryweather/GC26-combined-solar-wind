...
if seasonal_datasets:
    ...
    cbar.set_label(r"Events $Period^{-1}$", fontsize=14, fontweight="bold")
    
    #fig.suptitle(f"Climatological Mean Compound Drought Events by Season (1979-2020)", fontsize=16, fontweight="bold", y=0.96)
...
if os.path.exists(annual_file):
    ...
    cbar.set_label(r"Events $Year^{-1}$", fontsize=14, fontweight="bold")
    
    #fig_ann.suptitle("Annual Mean Compound Drought Events (1979-2020)", fontsize=14, fontweight="bold", y=0.92)
