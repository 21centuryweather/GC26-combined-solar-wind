...
# cf_threshold = 0.1
cf_threshold = float(sys.argv[2])/100. #in percent
...
for season_name, months in seasons_dict.items():
    ...
    yearly_filename = os.path.join(output_path, f"compound_lulls_{season_name}_{int(round(cf_threshold*100))}pc_{year}.nc")
