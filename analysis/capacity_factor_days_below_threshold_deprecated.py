...
# -------------------------------------------------------
# Usage: qsub capacity_factor_days_below_threshold_calc.sh
# Input: one column (year).
# For trial, change the year to a number, then do python capacity_factor_dauys_below_threshold.py
# -------------------------------------------------------
...
da_sum_combined.to_nc(f"{folder_out}/days_capacity_factor_lower_than_{cf_threshold}pc_{year}.nc")
